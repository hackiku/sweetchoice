...
export default function Contact() {
	...
	return (
		<div className="flex flex-col items-center relative min-h-screen">
			{/* Background Pattern */}
			<div className="w-full bg-gradient-to-b from-[#AE7AFF] to-transparent pt-14 pb-[75vh] absolute top-0 left-0 z-0"
				style={{
			...
			<div className="w-full relative z-10">
				...
				<section className="w-full flex flex-col justify-center px-6 sm:px-8 md:px-12 mb-12 mt-16 relative isolate">
					...
					<h1 className="text-[14vw] sm:text-[10vw] md:text-[8vw] font-bold leading-tight text-orange-400 relative z-[2]"
						...
						{t('contactPage.page.heading')} 
						{/* <br /> */}
						{t('contactPage.page.subheading')}
					</h1>
				</section>
				...
				<section className="w-full px-6 sm:px-8 md:px-12 mb-16">
					<div className="max-w-6xl mx-auto">
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
							...
							{/* Middle Column - Selected Products */}
							<div className="md:col-span-1">
				...
				<section className="w-full px-6 sm:px-8 md:px-12 mb-16">
					<div className="max-w-4xl mx-auto text-center">
						<h2 className="text-4xl sm:text-5xl md:text-6xl font-semibold mb-8">
							{t('contactPage.page.footer.title')}
						</h2>
						<p className="text-xl font-semibold mb-8 max-w-2xl mx-auto">
							{t('contactPage.page.footer.description')}
						</p>

						<div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
							<div className="bg-[#90EE90] border-4 border-black rounded-xl p-8 
                       shadow-[8px_8px_0px_rgba(0,0,0,1)]">
								<h3 className="text-2xl font-bold mb-4">
									{t('contactPage.page.footer.business.title')}
								</h3>
								<p className="text-lg">
									{t('contactPage.page.footer.business.description')}
								</p>
							</div>

							<div className="bg-[#FFA500] border-4 border-black rounded-xl p-8 
                       shadow-[8px_8px_0px_rgba(0,0,0,1)]">
								<h3 className="text-2xl font-bold mb-4">
									{t('contactPage.page.footer.support.title')}
								</h3>
								<p className="text-lg">
									{t('contactPage.page.footer.support.description')}
								</p>
							</div>
						</div>
					</div>
