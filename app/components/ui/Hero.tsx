...
const Hero: React.FC = () => {
	...
	return (
		<section className="relative h-[80vh] flex flex-col justify-between overflow-hidden  border-black">
			{/* Background gradient with dot pattern */}
			<MobileVideo />
			<div className="absolute inset-0 z-0 __bg-gradient-to-b __from-[#00A86B] to-transparent"
				style={{
					backgroundImage: 'radial-gradient(#000 1px, transparent 1px), __linear-gradient(to bottom, #00A86B, transparent)',
			...
			<div className="flex-grow flex flex-col justify-start relative z-10 px-6 sm:px-8 md:px-12">
				<div className="w-full">
					<h1 className="text-[14vw] sm:text-[9vw] md:text-[7vw] font-bold leading-tight mb-6 uppercase text-orange-400 w-full"
						style={{
						...
						{t('home.hero.headingTop')} <br></br>
						{t('home.hero.headingBottom')}
					</h1>

					{/* Desktop: inline layout, Mobile: stacked */}
					<div className="flex flex-col __md:flex-row __md:items-center __md:justify-between gap-6">
			...
			<div className="absolute -mx-4 z-0 bottom-0 w-[calc(100vw+2rem)]">
				<LogoMarquee />
			</div>
		</section>
	);
