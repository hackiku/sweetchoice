...
const Card: React.FC<CardProps> = ({
	...
	const { toggleProduct, isProductSelected, openContact } = useContact();
	...
	const handleToggleCatalog = (e: React.MouseEvent | React.TouchEvent) => {
		e.preventDefault();
		e.stopPropagation();
				...
				<div className="flex justify-between items-center mb-4">
					...
					>
						<button
							...
							onTouchStart={handleToggleCatalog}
